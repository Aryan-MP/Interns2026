ARM Template Deployment – Multi OS (Windows + Linux) Project Overview
...
Task 2 – Monitoring ARM Deployment Monitor Deployment in Azure Portal Second task deploy ARM templete using Custom deployment

ARM template (storage(1).json) Task 2 – Monitoring ARM Deployment Monitor Deployment in Azure Portal

1️⃣ Go to Azure Portal 2️⃣ Navigate to Resource Groups 3️⃣ Select your Resource Group 4️⃣ Click Deployments
